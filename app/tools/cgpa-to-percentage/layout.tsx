...
export const metadata: Metadata = {
  title: {
    absolute:
      "CGPA to Percentage Calculator — VTU, Anna University, CBSE | WorkUtilities",
  },
  description:
    "Convert CGPA to percentage using VTU, CBSE, and 4-point scale formulas. Reverse percentage to CGPA converter included.",
  keywords:
    "cgpa to percentage calculator, vtu cgpa to percentage, cbse cgpa to percentage, percentage to cgpa",
  openGraph: {
    title: "CGPA to Percentage Calculator — VTU, Anna University, CBSE",
    description:
