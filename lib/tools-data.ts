...
export const ALL_TOOLS = [
  ...
  },
  {
    ...
    href: "/tools/gst-threshold-checker",
    icon: "FileCheck",
    color: "#10B981",
    bgClass: "bg-tool-convert/10",
    textClass: "text-tool-convert",
...
export const RELATED_TOOLS: Record<string, string[]> = {
  ...
  "robots-txt-generator": ["htaccess-generator", "dns-lookup", "cron-generator"],
  "capital-gains-calculator": ["income-tax-calculator", "tax-regime-comparison", "freelancer-tax-calculator"],
  "rd-calculator": ["fd-calculator", "sip-calculator", "ppf-calculator"],
  "glassmorphism-generator": ["css-gradient", "robots-txt-generator", "cron-generator"],
  "htaccess-generator": ["robots-txt-generator", "dns-lookup", "cron-generator"],
  "nps-calculator": ["ppf-calculator", "epf-calculator", "sip-calculator"],
  "401k-calculator": ["w2-vs-1099-calculator", "self-employment-tax", "paycheck-calculator"],
  "leave-encashment-calculator": ["gratuity-calculator", "notice-period-calculator", "ctc-calculator"],
  "box-shadow-generator": ["glassmorphism-generator", "css-gradient", "color-picker"],
  "cagr-calculator": ["sip-calculator", "compound-interest", "fd-calculator"],
  "ssy-calculator": ["ppf-calculator", "nps-calculator", "rd-calculator"],
  "advance-tax-calculator": ["income-tax-calculator", "freelancer-tax-calculator", "tax-regime-comparison"],
  "color-palette-generator": ["glassmorphism-generator", "css-gradient", "box-shadow-generator", "color-picker"],
  "professional-tax-calculator": ["ctc-calculator", "income-tax-calculator", "hra-calculator"],
  "pay-stub-generator": ["paycheck-calculator", "w2-vs-1099-calculator", "self-employment-tax"],
  "markdown-table": ["json-formatter", "markdown-to-html", "robots-txt-generator"],
  "http-status-codes": ["json-formatter", "dns-lookup", "jwt-decoder"],
  "401k-vs-roth-ira": ["401k-calculator", "paycheck-calculator", "self-employment-tax"],
  "bonus-calculator": ["salary-hike-calculator", "ctc-calculator", "gratuity-calculator"],
  "esi-calculator": ["epf-calculator", "professional-tax-calculator", "ctc-calculator"],
  "swp-calculator": ["sip-calculator", "fd-calculator", "nps-calculator"],
  "dividend-yield-calculator": ["sip-calculator", "swp-calculator", "fd-calculator"],
  "gst-threshold-checker": ["freelancer-tax-calculator", "gst-calculator", "income-tax-calculator"],
  "hsa-calculator": ["401k-calculator", "401k-vs-roth-ira", "self-employment-tax"],
  "json-schema-validator": ["json-formatter", "http-status-codes", "jwt-decoder"],
...
> = {
  ...
  "capital-gains-calculator": { accent: "photo", filterCategory: "convert", popular: true },
  "rd-calculator": { accent: "photo", filterCategory: "convert" },
  "glassmorphism-generator": { accent: "image", filterCategory: "convert" },
  "htaccess-generator": { accent: "blue", filterCategory: "convert" },
  "nps-calculator": { accent: "photo", filterCategory: "convert", popular: true },
  "401k-calculator": { accent: "blue", filterCategory: "convert", popular: true },
  "leave-encashment-calculator": { accent: "convert", filterCategory: "convert" },
  "box-shadow-generator": { accent: "image", filterCategory: "convert" },
  "cagr-calculator": { accent: "convert", filterCategory: "convert", popular: true },
  "ssy-calculator": { accent: "photo", filterCategory: "convert" },
  "advance-tax-calculator": { accent: "photo", filterCategory: "convert", popular: true },
  "color-palette-generator": { accent: "image", filterCategory: "convert" },
  "professional-tax-calculator": { accent: "convert", filterCategory: "convert" },
  "pay-stub-generator": { accent: "blue", filterCategory: "convert" },
  "markdown-table": { accent: "image", filterCategory: "convert" },
  "http-status-codes": { accent: "blue", filterCategory: "convert" },
  "401k-vs-roth-ira": { accent: "blue", filterCategory: "convert", popular: true },
  "bonus-calculator": { accent: "convert", filterCategory: "convert" },
  "esi-calculator": { accent: "convert", filterCategory: "convert" },
  "swp-calculator": { accent: "photo", filterCategory: "convert", popular: true },
  "dividend-yield-calculator": { accent: "photo", filterCategory: "convert", popular: true },
  "gst-threshold-checker": { accent: "convert", filterCategory: "convert" },
  "hsa-calculator": { accent: "blue", filterCategory: "convert", popular: true },
  "json-schema-validator": { accent: "blue", filterCategory: "convert" },
