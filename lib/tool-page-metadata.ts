...
export const TOOL_PAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  "emi-calculator": "Free EMI calculator for home, car, and personal loans in India. Calculate monthly EMI, total interest, and full repayment instantly. No signup required.",
  ...
  "unit-converter": "Convert length, weight, temperature, area, volume, speed, and data units instantly. Free online unit converter with real-time results for metric and imperial.",
