...
export const TOOL_PAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  "dividend-yield-calculator": "Calculate dividend yield, yield on cost, and annual income from Indian stocks. Portfolio view, TDS calculation, FD comparison. Free, no signup.",
  "gst-threshold-checker": "Do you need GST registration? Check the ₹20 lakh threshold for Indian freelancers and IT contractors. Special state rules, inter-state, and export explained. Free tool.",
  "hsa-calculator": "Calculate HSA contribution limits, tax savings, and retirement balance. 2026 IRS limits: $4,300 individual / $8,550 family. Triple tax advantage explained. Free.",
  "json-schema-validator": "Validate JSON data against a JSON Schema in real-time. Supports Draft 7 and Draft 2020-12. Human-readable error messages with path. Free, browser-based.",
  ...
  "word-to-pdf": "Convert Word documents to PDF online free. Preserves fonts, tables, images, and layout via secure server processing.",
