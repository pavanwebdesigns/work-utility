...
const TOOL_SEO_CONTENT: Record<ToolSeoSlug, ToolSeoEntry> = {
  ...
  "nps-calculator": {
    aboutTitle: "About NPS Calculator India",
    aboutParagraphs: [
      ...
      "Adjust monthly contribution, age, expected return, annuity percentage, and annuity rate. Year-by-year growth table with old vs new regime tax callout.",
      "No signup, runs entirely in your browser — your financial data stays private.",
    ],
    whenToUseTitle: "When Should You Use the NPS Calculator?",
    useCases: [
      { title: "Retirement planning", description: "Project NPS corpus at age 60 with market-linked return assumptions." },
      { title: "Pension estimation", description: "See monthly pension based on annuity corpus and ASP rate." },
      { title: "Tax savings", description: "Estimate 80CCD(1) and 80CCD(1B) deductions under old regime." },
      { title: "Annuity vs lump sum", description: "Compare 40% to 100% annuity allocation impact." },
      { title: "NPS vs PPF", description: "Model NPS alongside PPF and EPF for holistic retirement planning." },
    ],
    faqs: [
      { question: "What is the minimum monthly contribution to NPS?", answer: "The minimum contribution to NPS Tier 1 is ₹500 per month, or ₹1,000 per year. There is no maximum limit on contributions, though tax deductions under Section 80CCD are capped at 10% of salary under 80CCD(1) and an additional ₹50,000 under 80CCD(1B)." },
      { question: "Can I withdraw the full NPS corpus at retirement?", answer: "No — at least 40% of the NPS corpus must be used to purchase an annuity from a PFRDA-approved Annuity Service Provider (ASP) to receive a regular monthly pension. You can withdraw the remaining 60% as a tax-free lump sum at retirement." },
      { question: "Is NPS better than PPF?", answer: "Both serve different purposes. NPS is market-linked with potentially higher returns (10-12% historically) and offers additional ₹50,000 deduction under 80CCD(1B), but has a mandatory annuity component and limited liquidity. PPF offers guaranteed 7.1% returns, complete EEE tax status, and more flexibility for partial withdrawals. For retirement planning, combining both is often recommended." },
      { question: "Is NPS available under the new tax regime?", answer: "Under the new tax regime, only your employer's NPS contribution under Section 80CCD(2) is deductible (up to 10% of salary for private employees). Self-contributions under 80CCD(1) and the extra ₹50,000 under 80CCD(1B) are not available under the new regime." },
      { question: "Is this calculator free?", answer: "Yes. WorkUtilities NPS Calculator is free with no signup." },
    ],
    blogGuide: {
      href: "/blog/nps-calculator-guide-india",
      title: "NPS calculator India — retirement corpus & pension guide",
    },
  },
  "401k-calculator": {
    aboutTitle: "About 401k Calculator",
    aboutParagraphs: [
      "Our free 401k Calculator projects retirement balance with 2026 IRS contribution limits auto-applied by age — including SECURE 2.0 super catch-up for ages 60-63.",
      "Shows employer match impact, tax savings, year-by-year balance table, and estimated monthly retirement income using the 4% rule.",
      "No signup, runs entirely in your browser. Privacy-first — your salary data never leaves your device.",
    ],
    whenToUseTitle: "When Should You Use the 401k Calculator?",
    useCases: [
      { title: "Retirement projection", description: "See projected 401k balance at your target retirement age." },
      { title: "Employer match", description: "Quantify free money from employer matching contributions." },
      { title: "Contribution planning", description: "Check if you're on track to max out 2026 IRS limits." },
      { title: "Catch-up contributions", description: "See higher limits for ages 50+ and 60-63 super catch-up." },
      { title: "Tax savings", description: "Estimate federal tax reduction from traditional 401k contributions." },
    ],
    faqs: [
      { question: "What is the 401k contribution limit for 2026?", answer: "For 2026, employees under 50 can contribute up to $24,500. Workers aged 50-59 and 64+ can contribute $32,500 (including a $8,000 catch-up). Workers aged 60-63 can contribute up to $35,750 under the SECURE 2.0 Act's super catch-up provision. Employer matching contributions are separate and bring the combined limit to $72,000." },
      ...
      { question: "What is the employer 401k match and why does it matter?", answer: "An employer match is money your company adds to your 401k — essentially free money. A common structure is \"50% of your contributions up to 6% of salary,\" meaning if you contribute 6%, your employer adds another 3%. Not capturing the full match is equivalent to leaving part of your compensation on the table." },
      { question: "What is the SECURE 2.0 super catch-up contribution?", answer: "Under the SECURE 2.0 Act, workers aged 60-63 can make \"super catch-up\" contributions of an additional $11,250 beyond the base limit in 2026, for a total of $35,750. This window was specifically created for workers who are behind on retirement savings and have a few peak earning years before retirement." },
      { question: "Is this calculator free?", answer: "Yes. WorkUtilities 401k Calculator is free with no signup." },
    ],
    blogGuide: {
      href: "/blog/401k-calculator-guide-usa",
      title: "401k calculator 2026 — retirement savings guide",
    },
  },
  "leave-encashment-calculator": {
    aboutTitle: "About Leave Encashment Calculator India",
    aboutParagraphs: [
      "Our free Leave Encashment Calculator computes encashment amount for private and government sector formulas, with tax exemption under Budget 2023's ₹25 lakh limit.",
      "Choose during-service (fully taxable) vs retirement/resignation (partially exempt). See exemption breakdown and net after-tax amount.",
      "No signup, runs entirely in your browser — ideal for IT employees planning resignation.",
    ],
    whenToUseTitle: "When Should You Use the Leave Encashment Calculator?",
    useCases: [
      { title: "Resignation planning", description: "Estimate leave encashment before putting in notice." },
      { title: "Tax planning", description: "See if encashment falls within ₹25L exemption at retirement." },
      { title: "HR negotiation", description: "Verify company calculation against standard formulas." },
      { title: "Full and final", description: "Understand tax on F&F settlement components." },
      { title: "Government vs private", description: "Compare ÷26 vs ÷300 day basis formulas." },
    ],
    faqs: [
      { question: "Is leave encashment taxable in India?", answer: "Leave encashment during service is fully taxable as income. Leave encashment at retirement or resignation is partially exempt — the exemption is the minimum of the actual amount received, 10 months' salary, cash equivalent of leave, or ₹25 lakhs (the limit was raised from ₹3 lakhs to ₹25 lakhs in Budget 2023)." },
      { question: "How is leave encashment calculated for private sector employees?", answer: "For private sector employees, leave encashment is typically calculated as: (Monthly Basic Salary ÷ 26 working days) × Number of leave days to be encashed. Some companies use 30 days per month; check your employment agreement or company HR policy." },
      { question: "What is the ₹25 lakh leave encashment exemption?", answer: "Budget 2023 raised the tax exemption limit for leave encashment at retirement or resignation from ₹3 lakhs to ₹25 lakhs for non-government employees. This exemption applies to the minimum of actual encashment received, 10 months' average salary, or ₹25 lakhs — whichever is lowest." },
      { question: "Are casual leaves and sick leaves encashable?", answer: "Generally, only Earned Leave (EL) or Privilege Leave (PL) is eligible for encashment. Casual Leave (CL) and Sick Leave (SL) typically lapse unused and cannot be encashed, though specific rules depend on your employer's leave policy and applicable state labour laws." },
      { question: "Is this calculator free?", answer: "Yes. WorkUtilities Leave Encashment Calculator is free with no signup." },
    ],
    blogGuide: {
      href: "/blog/leave-encashment-calculator-guide-india",
      title: "Leave encashment India — rules, tax exemption & calculation",
    },
  },
  "box-shadow-generator": {
    aboutTitle: "About Box Shadow CSS Generator",
    aboutParagraphs: [
    ...
    whenToUseTitle: "When Should You Use the Box Shadow Generator?",
    useCases: [
      { title: "Card elevation", description: "Add realistic depth to cards and modals." },
      { title: "Multi-layer shadows", description: "Stack shadows like Apple and Google design systems." },
      { title: "Inset effects", description: "Create pressed button and input field depth." },
      { title: "Colored glows", description: "Generate accent glow effects for dark mode UIs." },
      { title: "Tailwind projects", description: "Export arbitrary Tailwind box-shadow values." },
    ],
    faqs: [
      { question: "What is a CSS box-shadow?", answer: "CSS box-shadow adds shadow effects to an element. It takes up to 6 values: horizontal offset, vertical offset, blur radius, spread radius, color, and an optional \"inset\" keyword for inner shadows. Multiple comma-separated shadows can be stacked for more realistic, layered effects." },
      { question: "How do I create an inset shadow in CSS?", answer: 'Add the "inset" keyword before the other values: box-shadow: inset 0 2px 4px rgba(0,0,0,0.2). Inset shadows appear inside the element instead of outside, useful for creating pressed button states or depth effects on input fields.' },
      { question: "How do multi-layer shadows work?", answer: "Multiple box-shadow values separated by commas stack on top of each other. This technique creates more realistic shadows by simulating how light in the real world produces soft, diffused shadows. Apple's design system, for example, uses 3-4 shadow layers at different blur intensities." },
      { question: "What is the difference between box-shadow and filter:drop-shadow?", answer: "box-shadow only applies to the element's rectangular box — it doesn't follow the element's border-radius or transparent cutouts. filter:drop-shadow follows the element's actual shape, including transparency. However, box-shadow is generally more performant and better supported. Use filter:drop-shadow for non-rectangular elements like PNG icons." },
      { question: "Is this generator free?", answer: "Yes. WorkUtilities Box Shadow CSS Generator is free with no signup." },
    ],
    blogGuide: {
  ...
  "professional-tax-calculator": {
    aboutTitle: "About Professional Tax Calculator India",
    aboutParagraphs: [
    ...
    whenToUseTitle: "When Should You Use the Professional Tax Calculator?",
    useCases: [
      { title: "Salary breakdown", description: "See how much PT is deducted from your monthly salary." },
      { title: "Job offer comparison", description: "Compare take-home across states with different PT slabs." },
      { title: "Maharashtra employees", description: "Check women's exemption and February ₹300 adjustment." },
      { title: "Tax planning", description: "Estimate Section 16(iii) deduction benefit on income tax." },
      { title: "Remote work", description: "Understand PT is based on employer's registered state." },
    ],
    faqs: [
      { question: "What is the maximum Professional Tax in India?", answer: "The maximum professional tax any state can levy is ₹2,500 per year, as capped by Article 276 of the Indian Constitution. Most states with a simple slab structure have a maximum of ₹2,400-₹2,500 annually." },
      { question: "Which states in India don't have Professional Tax?", answer: "Professional Tax is not levied in several major states including Delhi, Uttar Pradesh, Rajasthan, Haryana, Punjab, Uttarakhand, Himachal Pradesh, and Goa. Professional Tax is a state subject and these states have chosen not to implement it." },
      { question: "Why is Maharashtra PT ₹300 in February?", answer: "Maharashtra's standard PT is ₹200/month. However, if you deduct ₹200 × 12 = ₹2,400 annually, it falls ₹100 short of the ₹2,500 constitutional limit. To maximize collection within the limit, Maharashtra charges ₹300 in February (₹200 + ₹100 extra), bringing the annual total to exactly ₹2,500." },
      { question: "Are women exempt from Professional Tax in Maharashtra?", answer: "Yes — women earning ₹25,000 or less per month are exempt from Professional Tax in Maharashtra. For women earning above ₹25,000/month, standard PT rates apply." },
      { question: "Is this calculator free?", answer: "Yes. WorkUtilities Professional Tax Calculator is free with no signup." },
    ],
    blogGuide: {
      href: "/blog/professional-tax-calculator-guide-india",
      title: "Professional tax India — state-wise slabs guide",
    },
  },
  "pay-stub-generator": {
    aboutTitle: "About Pay Stub Generator",
    aboutParagraphs: [
      "Our free Pay Stub Generator creates professional US pay stubs entirely in your browser — no data sent to any server.",
      "Enter company and employee details, earnings rows, and deductions. Federal tax is estimated from 2026 brackets; FICA (Social Security and Medicare) is auto-calculated.",
      "Print or save as PDF using your browser's print function. Privacy-first — close the tab to clear all data.",
    ],
    whenToUseTitle: "When Should You Use the Pay Stub Generator?",
    useCases: [
      { title: "Income documentation", description: "Create reference pay stubs for rental applications or records." },
      { title: "Freelancer records", description: "Document earnings when you don't receive employer stubs." },
      { title: "Small business", description: "Generate pay stubs for employees without payroll software." },
      { title: "Privacy-sensitive", description: "Browser-only — no pay data uploaded to servers." },
      { title: "Quick PDF", description: "Print to PDF instantly without account signup." },
    ],
    faqs: [
      { question: "Can I use this pay stub for a rental application?", answer: "A pay stub generated by this tool can be used as a reference document to show income, but some landlords and banks may require official pay stubs from your employer or payroll provider. If in doubt, check with the requesting party what documentation format they accept." },
      { question: "How accurate are the tax deductions?", answer: "Federal income tax is estimated based on 2026 tax brackets for single filers. Social Security (6.2%) and Medicare (1.45%) are calculated accurately per IRS rates. State income tax requires manual entry as it varies significantly by state. For payroll tax accuracy, use an official payroll service." },
      { question: "Is my pay information safe to enter here?", answer: "Yes — this tool runs entirely in your browser. No pay data is ever sent to a server. Your information is not stored, logged, or transmitted. Close the browser tab to clear all data." },
      { question: "What is the difference between gross pay and net pay?", answer: "Gross pay is your total earnings before any deductions. Net pay (take-home pay) is what remains after federal tax, FICA (Social Security and Medicare), state tax, health insurance, and other deductions are subtracted. Your paycheck amount reflects net pay." },
      { question: "Is this generator free?", answer: "Yes. WorkUtilities Pay Stub Generator is free with no signup." },
    ],
    blogGuide: {
      href: "/blog/pay-stub-generator-guide-usa",
      title: "Pay stub generator — free US paycheck creator guide",
    },
  },
  "markdown-table": {
    aboutTitle: "About Markdown Table Generator",
    aboutParagraphs: [
      "Our free Markdown Table Generator builds GFM-compatible tables with a visual grid editor or CSV paste import.",
      "Per-column alignment (left, center, right), add/remove rows and columns, live Markdown preview, and HTML table export.",
      "No signup, runs entirely in your browser. Perfect for GitHub READMEs, Notion, Obsidian, and developer docs.",
    ],
    whenToUseTitle: "When Should You Use the Markdown Table Generator?",
    useCases: [
      { title: "GitHub READMEs", description: "Create formatted tables for documentation." },
      { title: "CSV conversion", description: "Paste Excel or CSV data and get Markdown instantly." },
      { title: "Column alignment", description: "Center headers, right-align numbers." },
      { title: "Quick docs", description: "Skip manual pipe-and-dash typing." },
      { title: "HTML export", description: "Get an HTML table for non-Markdown contexts." },
    ],
    faqs: [
      { question: "What is the Markdown table syntax?", answer: "A Markdown table uses pipe characters (|) to separate columns and a row of dashes (---) to separate the header from the data rows. Minimum syntax: | Header 1 | Header 2 | (newline) |---|---| (newline) | Data 1 | Data 2 |. Alignment is added with colons: |:---| for left, |:---:| for center, |---:| for right." },
      { question: "How do I add alignment to a Markdown table?", answer: "Add colons to the separator row (dashes row): |:---| aligns the column left, |:---:| centers it, and |---:| aligns right. Without a colon, the default is left-aligned." },
      { question: "Can I convert Excel or CSV data to a Markdown table?", answer: "Yes — copy your Excel data (which copies as tab-separated values) or any CSV, paste it into the CSV import area, and the tool converts it to a properly formatted Markdown table automatically." },
      { question: "Which platforms support Markdown tables?", answer: "Markdown tables are supported in GitHub (README.md, issues, PRs), GitLab, Bitbucket, Notion, Obsidian, Joplin, VS Code Markdown preview, Jekyll and Hugo static site generators, and many documentation platforms. They are NOT supported in basic Markdown (CommonMark) — table support requires GitHub Flavored Markdown (GFM) or MultiMarkdown." },
      { question: "Is this generator free?", answer: "Yes. WorkUtilities Markdown Table Generator is free with no signup." },
    ],
    blogGuide: {
      href: "/blog/markdown-table-generator-guide",
      title: "Markdown table generator — syntax and CSV import guide",
    },
  },
  "http-status-codes": {
    aboutTitle: "About HTTP Status Codes Reference",
    aboutParagraphs: [
    ...
    whenToUseTitle: "When Should You Use the HTTP Status Codes Reference?",
    useCases: [
      { title: "API debugging", description: "Understand what 4xx and 5xx errors mean in your API responses." },
      { title: "401 vs 403", description: "Clarify authentication vs authorization errors." },
      { title: "Redirect codes", description: "Choose between 301, 302, 307, and 308." },
      { title: "Rate limiting", description: "Handle 429 Too Many Requests with backoff." },
      { title: "Quick lookup", description: "Searchable reference faster than reading MDN docs." },
    ],
    faqs: [
      { question: "What is the difference between HTTP 401 and 403?", answer: "401 Unauthorized means the request lacks valid authentication credentials — the user is not logged in or the token is missing/expired. 403 Forbidden means the request is authenticated (we know who you are) but you don't have permission to access this resource. If you receive a 401, check your authentication token. If you receive a 403, check user roles and permissions." },
      { question: "What is the difference between 301 and 302 redirects?", answer: "A 301 (Moved Permanently) tells browsers and search engines that the resource has permanently moved to a new URL — the redirect is cached and SEO authority transfers. A 302 (Found/Temporary Redirect) signals a temporary move — browsers don't cache it and SEO authority stays with the original URL. Use 301 for permanent URL changes, 302 for temporary redirects." },
      { question: "What does HTTP 429 Too Many Requests mean?", answer: "429 means you've sent too many requests in a given time period and the server is rate-limiting you. The response should include a Retry-After header indicating when you can retry. Implement exponential backoff in your code: wait 1 second, then 2, then 4, then 8, before retrying." },
      { question: "When should an API return 422 vs 400?", answer: "400 Bad Request is for malformed requests — syntax errors, invalid JSON format, missing required headers. 422 Unprocessable Entity is for requests that are syntactically correct but semantically invalid — for example, a well-formed JSON body where a field value fails business validation (e.g., age is -5). REST APIs increasingly use 422 for validation errors and 400 for format errors." },
      { question: "Is this reference free?", answer: "Yes. WorkUtilities HTTP Status Codes Reference is free with no signup." },
    ],
    blogGuide: {
